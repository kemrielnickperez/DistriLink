        ...
        <Grid item container sx={{ display: "flex", justifyContent: "center", marginTop: '10px' }}>
          <Grid item>
            <Paper sx={{ backgroundColor: '#ffffff', borderRadius: "22px", height: "200px", justifyContent: 'center', display: 'flex', alignItems: 'center', position: 'relative', width: '1200px' }}>
              ...
              <StyledQuantityField variant="outlined" InputProps={{ disableUnderline: true }} inputRef={quantityRef} />
              <AddToCart variant="contained" onClick={() => { handleAddToCart(); setOrderedProducts([...orderedProducts, createOrderedProduct(chosenProduct!, Number(quantityRef.current?.value), 0)]); }}>ADD TO CART</AddToCart>
            </Paper>
          </Grid>
        </Grid>
