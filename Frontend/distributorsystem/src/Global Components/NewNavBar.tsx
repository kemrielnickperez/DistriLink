                ...
                <ColorBox>
                    ...
                    <List>
                        ...
                        <StyledButton >
                            <StyledListItem>
                                <ListItemIcon>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FFFFFF" className="w-6 h-6" style={{marginLeft: 23, width: 25, height: 25}}>
